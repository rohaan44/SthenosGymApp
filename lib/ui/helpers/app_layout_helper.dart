...
// ── Tier helpers ───────────────────────────────────────────────
bool isPhone(BuildContext context)   => MediaQuery.of(context).size.width < kPhoneBreak;
bool isTablet(BuildContext context)  => MediaQuery.of(context).size.width >= kPhoneBreak && MediaQuery.of(context).size.width < kDesktopBreak;
bool isDesktop(BuildContext context) => MediaQuery.of(context).size.width >= kDesktopBreak;
...
EdgeInsets pageHPadding(BuildContext context) {
  if (isDesktop(context)) return EdgeInsets.symmetric(horizontal: cw(9.4), vertical: ch(8.1));
  if (isTablet(context))  return EdgeInsets.symmetric(horizontal: cw(11.2), vertical: ch(8.1));
