                      ...
                      child: phone
                          ...
                          : Row(
                              children: [
                                ...
                                SizedBox(width: cw(7.5).clamp(8.0, 16.0)),
                                SizedBox(
                                  width: 220,
                                  child: DropdownButtonFormField<String>(
                                    value: state.filterCategory,
                  ...
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      return Wrap(
                        spacing: 16.0,
                        runSpacing: 16.0,
                        children: filtered.map((gymClass) {
                          return SizedBox(
                            width: cardWidth,
...
class _ClassCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final pct = gymClass.enrolled / gymClass.capacity;
    final isFull =
        gymClass.status == 'Full' || gymClass.enrolled >= gymClass.capacity;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisSize: MainAxisSize.min, // Dynamic height system
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
            ...
            SizedBox(height: ch(10.0).clamp(8.0, 12.0)),
            _infoRow(Icons.person_outline, gymClass.trainer),
            SizedBox(height: ch(6.0).clamp(4.0, 8.0)),
            _infoRow(
              Icons.schedule_outlined,
              '${gymClass.schedule} · ${gymClass.time}',
            ),
            SizedBox(height: ch(6.0).clamp(4.0, 8.0)),
            _infoRow(Icons.category_outlined, gymClass.category),

            // Spacer hata kar fixed padding di taakay Wrap layout mein card height sahi calculations kare
            SizedBox(height: ch(16.0).clamp(12.0, 20.0)),
            ...
            Row(
              children: [
                ...
                SizedBox(width: cw(7.5).clamp(8.0, 12.0)),
                Text(
