...
class PaymentsScreen extends StatelessWidget {
          ...
          children: [
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      OutlinedButton.icon(
                        ...
                        label: AppText(txt: 'Export', fontSize: AppFontSize.f12),
                        onPressed: () {},
                      ),
                    ],
                  )
            ...
            StreamBuilder<List<Payment>>(
              ...
              builder: (context, snapshot) {
                ...
                final pendingCount =
                    allPayments.where((p) => p.status == 'Pending').length;
                final pendingTotal = allPayments
                    .where((p) => p.status == 'Pending')
                    .fold<double>(0, (s, p) => s + p.amount);
                final overdueCount =
                    allPayments.where((p) => p.status == 'Overdue').length;
  ...
  static Widget _statusDropdown(PaymentsProvider state,
  ...
  static DataRow _buildPaymentRow(Payment p) {
    ...
    return DataRow(cells: [
      ...
      DataCell(_StatusDropdownCell(
          payment: p, statusNotifier: statusNotifier)),
      // Save — reads from ValueNotifier and writes to Firestore.
      DataCell(_SaveButtonCell(
          payment: p, statusNotifier: statusNotifier)),
    ]);
  }
}
            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: customInputDecoration('Status').copyWith(
