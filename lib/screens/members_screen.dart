...
class MembersState extends ChangeNotifier {
  ...
  List<Member> filtered(List<Member> members) => members.where((m) {
    ...
    final matchStatus =
        _filterStatus == 'all' ||
        m.status.toLowerCase() == _filterStatus.toLowerCase();
...
class MembersScreen extends StatelessWidget {
  ...
  void _deleteMember(BuildContext context, int id) =>
      context.read<GymProvider>().deleteMember(id);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          phone
                              ? _MobileList(
                                  members: filtered,
                                  onDelete: (id) => _deleteMember(context, id),
                                )
